...
- Г, К, Х, Ж, Ч, Ш, Щ 的 Ы 替换成 И
- Ж, Ч, Ш, Щ, Ц 的 O 替换成 E
- Г, К, Х, Ж, Ч, Ш, Щ, Ц 的 Я 替换成 А
- Г, К, Х, Ж, Ч, Ш, Щ, Ц 的 Ю 替换成 У
...
1. 单数
   - Feminine中，-а变-у，-я变-ю，-ия变-ию，-ь不变
   - Masculine和Neutral中，若Animated则同Nom.（不变），若Inanimated则同Gen.
2. 复数
   - 若Animated则同Nom.（不变），若Inanimated则同Gen.
